...
public class MultipartProperties {
    ...
    public MultipartConfigElement createMultipartConfig() {
        ...
        if (StringUtils.hasText(this.fileSizeThreshold)) {
            factory.setFileSizeThreshold(DataSize.parse(this.fileSizeThreshold));
        }
        if (StringUtils.hasText(this.location)) {
            factory.setLocation(this.location);
        }
        if (StringUtils.hasText(this.maxRequestSize)) {
            factory.setMaxRequestSize(DataSize.parse(this.maxRequestSize));
        }
        if (StringUtils.hasText(this.maxFileSize)) {
            factory.setMaxFileSize(DataSize.parse(this.maxFileSize));
        }
